...
<body>
    ...
    <form action="../controller/profile_controller.php" method="POST">
        <?php echo $l["view_profile_editmail"] ?><input type="text" name="profile_mail" value="<? echo $user->getIdemail(); ?>" readonly/><br/>
        ...
        <?php if($user->getTable()=="establecimiento"){
          ...
          <?php } ?>
            <input type="hidden" name="type" value="<?php echo $user->getTable(); ?>" />
