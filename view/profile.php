        ...
        <div class="row">
          ...
          <div class="col-md-8 col-sm-12">
            ...
            <form role="form" action="../controller/profile_controller.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label for="name"><?php echo $l["view_profile_editpass"] ?></label>
                <input class="form-control" type="password" name="profile_pass" value="<? echo $user->getContrasena(); ?>" />
              </div>
              <div class="form-group">
                <label for="name"><?php echo $l["view_profile_editname"] ?></label>
                <input class="form-control" type="text" name="profile_name" value="<? echo $user->getNombre(); ?>" />
              </div>
              <div class="form-group">
              ...
              <?php if($user->getTable()=="juradoprofesional"){
               ...
               <div class="form-group">
                ...
                <textarea class="form-control" type="text" name="profile_curriculum"><? echo $user->getCurriculum(); ?></textarea>
              </div>
              ...
              <?php if($user->getTable()=="establecimiento"){
               ...
               <div class="form-group">
                ...
                <input class="form-control" type="text" name="profile_direccion" value="<? echo $user->getDireccion(); ?>" />
              </div>

              <div class="form-group">
                <label for="name"><?php echo $l["view_profile_web"] ?></label>
                <input class="form-control" type="text" name="profile_web" value="<? echo $user->getWeb(); ?>" />
              </div>
              <div class="form-group">
                <label for="name"><?php echo $l["view_profile_schedule"] ?></label>
                <input class="form-control" type="text" name="profile_horario" value="<? echo $user->getHorario(); ?>" />
              </div>
              <div class="form-group">
                <label for="name"><?php echo $l["view_profile_image"] ?></label>
                <input class="form-control" type="text" name="profile_rutaimagen" value="<? echo $user->getRutaimagen(); ?>" />
              </div>
              <div class="form-group">
